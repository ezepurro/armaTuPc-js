...
const productosDos = [
    { id: 5, class: "0", nombre: "Procesador Intel i3", precio: 25000, desc: "10th generacion 3ghz", img: "../img/i3.jpg" },
    { id: 6, class: "0", nombre: "Procesador Intel i5", precio: 40000, desc: "10th generacion 4ghz", img: "../img/i5.jpg" },
    { id: 7, class: "0", nombre: "Procesador Intel i7", precio: 60000, desc: "10th generacion 5ghz", img: "../img/i7.jpg" },
    { id: 8, class: "1", nombre: "RAM Kingston Fury Beast 8gb", precio: 5000, desc: "DDR4 2666Mhz", img: "../img/ramFury.jpg" },
    { id: 9, class: "1", nombre: "RAM PNY XLR8 Gaming 8gb", precio: 6000, desc: "DDR4 3000Mhz", img: "../img/PNYXLR8GMG.jpg" },
    { id: 10, class: "1", nombre: "RAM Adata XPG spectrix 8gb", precio: 8500, desc: "DDR4 3200Mhz", img: "../img/8gbadataxpgspectrix.jpg" },
    { id: 11, class: "2", nombre: "Gráfica 3060 ti KO Gaming", precio: 650000, desc: "Gddr6 8gb VRAM", img: "../img/pv3060tiKOgaming.jpg" },
    { id: 12, class: "2", nombre: "Gráfica 2060 Super", precio: 30000, desc: "Gddr6 6gb VRAM", img: "../img/pv2060super.jpg" },
    { id: 13, class: "2", nombre: "Gráfica Gamerock 3080", precio: 1500000, desc: "Gddr6 12gb VRAM", img: "../img/pvgamerock3080.jpg" },
    { id: 14, class: "3", nombre: "Mother Gigabyte z690", precio: 12000, desc: "Compatible con Intel", img: "../img/Gygabytez690UDs1700.jpg" },
    { id: 15, class: "3", nombre: "Mother Asus Prime Z690", precio: 10000, desc: "Compatible con Intel", img: "../img/AsusPrimeZ690-PS1700.jpg" },
    { id: 16, class: "3", nombre: "Mother Gigabyte z690-p", precio: 13000, desc: "Compatible con AMD", img: "../img/gigabytez690AorusEliteS1700.jpg" },
    { id: 17, class: "4", nombre: "Gabinete Essenses BZE30", precio: 15000, desc: "Con RGB, dimensiones: 321x321x400", img: "../img/EssensesBZE30TGCon3CoolersRGB.jpg" },
    { id: 18, class: "4", nombre: "Gabinete Aerocool Klaw RGB", precio: 20000, desc: "Con RGB, dimensiones: 500x321x600", img: "../img/AerocoolKlawRGB.jpg" },
    { id: 19, class: "4", nombre: "Gabinete Azza 110F Luminous", precio: 11000, desc: "Con RGB, dimensiones: 700x700x1000", img: "../img/Azza110FLuminous.jpg" }
]
...
function HacerCompra() {
    if (!texto.innerText == "") {
        var link = "https://api.whatsapp.com/send?phone=5493515312196&text=Hola los componentes que he seleccionado son: \n" + texto.innerText
